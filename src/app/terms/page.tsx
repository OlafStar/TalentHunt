...
const Page = () => {
    return (
        <div className="flex flex-col gap-4 container mx-auto py-40 px-4 sm:px-6 lg:px-8">
            <h1 className="text-4xl font-bold text-gray-900">
                Terms and Conditions
            </h1>
            <p className="text-sm text-gray-500">Last updated: December 28, 2023</p>
            <div className="mt-6 text-gray-700 space-y-4">
                ...
                <ul className="list-disc pl-5 space-y-2">
                    ...
                    <li>
                        <p>
                            ...
                            to Olaf Nieliwodzki, Warmińska 8, Pasym 12-130.
                        </p>
                    </li>
                    <li>
                        <p>
                    ...
                    <li>
                        <p>
                            <strong>Website</strong> refers to TalentHunting,
                            accessible from{' '}
                            <a
                                href="https://talenthunting.co"
                                rel="external nofollow noopener noreferrer"
                                target="_blank"
                                className="text-blue-600 hover:underline"
                            >
                                https://talenthunting.co
                            </a>
                        </p>
                    </li>
                    <li>
                ...
                <p>
                    We reserves the right to deny refunds based on its own
                    self discretion and without notice or liability to Client. Refund
                    requests are assessed on a case by case basis. Should Client
                    request a refund during the first month of use. If a refund
                    is deemed to be appropriate, there will be a 25% fee assigned to
                    the remaining billable period. We reserves the right to
                    take appropriate legal actions against Client for breach of this
                    paragraph.
                </p>
                <h2 className="text-2xl font-semibold">
                ...
                <ul>
                    <li>By email: hello@talenthunting.co</li>
                </ul>
            </div>
        </div>
    );
